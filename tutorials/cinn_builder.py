...
builder = frontend.CinnBuilder(name="add_conv2d")
...
#
# :code:`type` the data type of input variable, now support Void, Int, UInt, Float,
# Bool and String, the parameter is the type's bit-widths.
#
