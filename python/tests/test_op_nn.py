...
class OpTest_pool1d(SingleOpTester):
    attrs = framework.NodeAttr()
    self.attrs.set_attr("kernel_size", [2])
    self.attrs.set_attr("stride_size", [2])
    self.attrs.set_attr("padding_size", [1, 1])
    self.attrs.set_attr("pool_type", "max")
    self.attrs.set_attr("ceil_mode", False)
    self.attrs.set_attr("exclusive", True)
    self.attrs.set_attr("data_format", "NCW")
...
class OpTest_pool1d_1(SingleOpTester):
    ...
    self.attrs.set_attr("kernel_size", [2])
    self.attrs.set_attr("stride_size", [2])
    self.attrs.set_attr("padding_size", [2, 3])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", False)
    self.attrs.set_attr("exclusive", True)
    self.attrs.set_attr("data_format", "NCW")
...
class OpTest_pool1d_2(SingleOpTester):
    attrs = framework.NodeAttr()
    self.attrs.set_attr("kernel_size", [2])
    self.attrs.set_attr("stride_size", [3])
    self.attrs.set_attr("padding_size", [4, 5])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", True)
    self.attrs.set_attr("exclusive", False)
    self.attrs.set_attr("data_format", "NWC")
...
class OpTest_pool2d(SingleOpTester):
    attrs = framework.NodeAttr()
    self.attrs.set_attr("kernel_size", [2, 2])
    self.attrs.set_attr("stride_size", [2, 2])
    self.attrs.set_attr("padding_size", [1, 1, 1, 1])
    self.attrs.set_attr("pool_type", "max")
    self.attrs.set_attr("ceil_mode", False)
    self.attrs.set_attr("exclusive", True)
    self.attrs.set_attr("data_format", "NCHW")
...
class OpTest_pool2d_1(SingleOpTester):
    ...
    self.attrs.set_attr("kernel_size", [2, 2])
    self.attrs.set_attr("stride_size", [2, 2])
    self.attrs.set_attr("padding_size", [2, 3, 4, 5])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", False)
    self.attrs.set_attr("exclusive", True)
    self.attrs.set_attr("data_format", "NCHW")
...
class OpTest_pool2d_2(SingleOpTester):
    attrs = framework.NodeAttr()
    self.attrs.set_attr("kernel_size", [2, 2])
    self.attrs.set_attr("stride_size", [3, 3])
    self.attrs.set_attr("padding_size", [2, 3, 4, 5])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", True)
    self.attrs.set_attr("exclusive", False)
    self.attrs.set_attr("data_format", "NHWC")
...
class OpTest_pool3d_1(SingleOpTester):
    attrs = framework.NodeAttr()
    self.attrs.set_attr("kernel_size", [2, 2, 2])
    self.attrs.set_attr("stride_size", [2, 2, 2])
    self.attrs.set_attr("padding_size", [1, 1, 1, 1, 1, 1])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", False)
    self.attrs.set_attr("exclusive", True)
    self.attrs.set_attr("data_format", "NCDHW")
...
class OpTest_pool3d_2(SingleOpTester):
    ...
    self.attrs.set_attr("kernel_size", [2, 2, 2])
    self.attrs.set_attr("stride_size", [2, 2, 2])
    self.attrs.set_attr("padding_size", [1, 2, 3, 4, 5, 6])
    self.attrs.set_attr("pool_type", "avg")
    self.attrs.set_attr("ceil_mode", True)
    self.attrs.set_attr("exclusive", False)
    self.attrs.set_attr("data_format", "NDHWC")
