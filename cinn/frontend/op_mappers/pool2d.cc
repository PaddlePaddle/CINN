...
void pool2d_kernel(const paddle::cpp::OpDesc& op_desc, const OpMapperContext& ctx) {
...
CINN_REGISTER_HELPER(pool2d) { CINN_REGISTER_OPMAPPER(pool2d, cinn::frontend::op_mappers::pool2d_kernel) }
