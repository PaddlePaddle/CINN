...
TEST(net_build, program_execute_one_hot) {
  ...
  NetBuilder builder("net_builder");
  Placeholder indices   = builder.CreateInput(Int(32), indices_shape, "indices");
  Placeholder on_value  = builder.CreateInput(Int(32), {1}, "on_value");
  Placeholder off_value = builder.CreateInput(Int(32), {1}, "off_value");
