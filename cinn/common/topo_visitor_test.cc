...
#include "cinn/common/topo_visitor.h"
...
TEST(TopoVisitor, simple) {
  std::vector<std::pair<int, int>> edges{{0, 3}, {1, 2}, {1, 3}, {2, 3}, {3, 4}};
  ...
  visitor(sources.begin(), sources.end(), [&](int node) { outputs.push_back(node); });
