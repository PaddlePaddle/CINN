...
void matmul(void* _args, int32_t num_args)
{
  ...
  for (int32_t i_outer = 0; (i_outer <= 63); i_outer += 1) {
    for (int32_t i_inner = 0; (i_inner <= 7); i_inner += 1) {
      for (int32_t j_outer = 0; (j_outer <= 62); j_outer += 1) {
        for (int32_t j_inner = 0; (j_inner <= cinn_min(7, ((-8 * j_outer) + 499))); j_inner += 1) {
          for (int32_t k0 = 0; (k0 <= 199); k0 += 1) {
