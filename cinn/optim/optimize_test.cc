  ...
  auto out = R"ROC(
{
  for (i, 0, 100)
  {
    for (j_outer, 0, 4)
    {
      tensor[i, (j_outer * 5)] = (A[i, (j_outer * 5)] + 1)
      tensor[i, ((j_outer * 5) + 1)] = (A[i, ((j_outer * 5) + 1)] + 1)
      tensor[i, ((j_outer * 5) + 2)] = (A[i, ((j_outer * 5) + 2)] + 1)
      tensor[i, ((j_outer * 5) + 3)] = (A[i, ((j_outer * 5) + 3)] + 1)
      tensor[i, ((j_outer * 5) + 4)] = (A[i, ((j_outer * 5) + 4)] + 1)
    }
  }
}
)ROC";
