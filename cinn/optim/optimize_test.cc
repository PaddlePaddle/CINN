  ...
  auto out = R"ROC(
{
  serial for (i, 0, 100)
  {
    ...
    {
      C[i, (5 * j_outer)] = (1.00000f + A[i, (5 * j_outer)])
      C[i, (1 + (5 * j_outer))] = (1.00000f + A[i, (1 + (5 * j_outer))])
      C[i, (2 + (5 * j_outer))] = (1.00000f + A[i, (2 + (5 * j_outer))])
      C[i, (3 + (5 * j_outer))] = (1.00000f + A[i, (3 + (5 * j_outer))])
      C[i, (4 + (5 * j_outer))] = (1.00000f + A[i, (4 + (5 * j_outer))])
    }
  }
}
)ROC";
