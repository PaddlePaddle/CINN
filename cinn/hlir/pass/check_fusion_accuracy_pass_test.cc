...
TEST(CheckFusionAccuracyPass, General_ElementWise_Fusion) {
  int h = 32, w = 32;
  NetBuilder net_builder("ElementWise_Fusion_0");
  std::unordered_set<std::string> fetch_ids;
  // create model
  ...
  auto graph = std::make_shared<Graph>(program, target);
  hlir::framework::ApplyPasses(graph.get(), {"OpFusionPass", "GeneralFusionMergePass"});
...
TEST(CheckFusionAccuracyPass, General_ElementWise_Fusion_2) {
  int h = 32, w = 32;
  NetBuilder net_builder("ElementWise_Fusion_2");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_ElementWise_Fusion_3) {
  int h = 32, w = 32;
  NetBuilder net_builder("ElementWise_Fusion_3");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_ElementWise_Fusion_4) {
  int h = 32, w = 32;
  NetBuilder net_builder("ElementWise_Fusion_4");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_ElementWise_Fusion_5) {
  int h = 32, w = 32;
  NetBuilder net_builder("ElementWise_Fusion_5");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Broadcast_Test_0) {
  int h = 32, w = 32;
  NetBuilder net_builder("Broadcast_Test_0");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Broadcast_Test_2) {
  int h = 32, w = 32;
  NetBuilder net_builder("Broadcast_Test_2");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Broadcast_Test_4) {
  int h = 32, w = 32;
  NetBuilder net_builder("Broadcast_Test_4");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Broadcast_Test_5) {
  int h = 32, w = 32;
  NetBuilder net_builder("Broadcast_Test_5");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Reduce_Test_0) {
  int h = 32, w = 32;
  NetBuilder net_builder("Reduce_Test_0");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Reduce_Test_1) {
  int h = 32, w = 32;
  NetBuilder net_builder("Reduce_Test_1");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Reduce_Test_2) {
  int h = 32, w = 32;
  NetBuilder net_builder("Reduce_Test_2");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Reduce_Test_4) {
  int h = 32, w = 32;
  NetBuilder net_builder("Reduce_Test_4");
  // create model
  {
...
TEST(CheckFusionAccuracyPass, General_Reduce_Test_5) {
  int h = 128, w = 128;
  NetBuilder net_builder("Reduce_Test_5");
  // create model
  {
