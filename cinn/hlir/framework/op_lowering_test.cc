...
TEST(OP_LOWERING, OpaqueOp_TEST_5) {
  NetBuilder net_builder("OpaqueOp_TEST_5");
  {
    auto A = net_builder.CreateInput(Float(32), {16, 16, 224, 224}, "A");
    auto B = net_builder.CreateInput(Float(32), {16, 1, 5, 5}, "B");
    auto C = net_builder.DepthwiseConv2d(A, B, {2, 2}, {2, 2}, {1, 1}, 16);
  }
