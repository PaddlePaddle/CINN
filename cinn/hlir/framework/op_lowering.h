...
class OpLowerer {
 ...
 private:
   ...
   * @param apply_op_schedule Whether to schedule at Op level.
   * @param apply_group_schedule Whether to schedule at group level.
   * @param schedule_determine_func Function used to determine which Ops to schedule.
   * @return The lowered funcs.
   */
  ...
  /**
   * @brief Post processing, including preparing function args and temporary variables,
   ...
   * @param done_op_schedule Mark whether the Op level schedule has been applied.
   ...
   *        Compute, Lower and optional Schedule will be performed one by one for each Op.
  ...
  /**
   * @brief Lower an Op to CINN IR. The Compute and Lower processes will be called sequentially.
   ...
   * @param ir_sch The IRSchedule containing the entire group's lowered func bodies.
  ...
  // Functions used to determine which Ops to schedule at op level, define a policy for each type of group.
