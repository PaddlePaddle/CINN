...
void add1(void* _args, int32_t num_args)
{
  ...
  for (int32_t i_outer = 0; i_outer < 25; i_outer += 1) {
    for (int32_t i_inner = 0; i_inner < 4; i_inner += 1) {
      for (int32_t j = 0; j < 20; j += 1) {
        C[((20 * i_inner) + ((80 * i_outer) + j))] = (1.00000000f + fma(3.00000000f, A[((20 * i_inner) + ((80 * i_outer) + j))], B[((20 * i_inner) + ((80 * i_outer) + j))]));
      };
    };
  };
      ...
      for (int32_t i_inner = 0; i_inner < 4; i_inner += 1) {
        for (int32_t j_outer = 0; j_outer < 2; j_outer += 1) {
          for (int32_t j_inner = 0; j_inner < cinn_min(16, (20 + (-16 * j_outer))); j_inner += 1) {
            D[((20 * i_inner) + ((80 * i_outer) + ((16 * j_outer) + j_inner)))] = fma(4.00000000f, (C[((20 * i_inner) + ((80 * i_outer) + ((16 * j_outer) + j_inner)))] * A[((20 * i_inner) + ((80 * i_outer) + ((16 * j_outer) + j_inner)))]), (2.00000000f * C[((20 * i_inner) + ((80 * i_outer) + ((16 * j_outer) + j_inner)))]));
          };
        };
      };
    }
