/**
 * \file This file contains all float16 intrinsics available to be used in CUDA code generated by CodeGen.
 */
...
#endif
__device__ inline float16 FN_FP16(erf)(float16 x) { return FUNC_FP32(erf)(static_cast<float>(x)); }

__device__ inline float16 FN_FP16(pow)(float16 x) { return FUNC_FP32(pow)(static_cast<float>(x)); }

__device__ inline float16 FN_FP16(cosh)(float16 x) { return FUNC_FP32(cosh)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(tanh)(float16 x) { return FUNC_FP32(tanh)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(asin)(float16 x) { return FUNC_FP32(asin)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(acos)(float16 x) { return FUNC_FP32(acos)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(acosh)(float16 x) { return FUNC_FP32(acosh)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(atanh)(float16 x) { return FUNC_FP32(atanh)(static_cast<float>(x)); }

__device__ inline float16 FN_FP16(sigmoid)(float16 x) { return FUNC_FP32(sigmoid)(static_cast<float>(x)); }
__device__ inline float16 FN_FP16(remainder)(float16 x) { return FUNC_FP32(remainder)(static_cast<float>(x)); }
#undef FUNC_FP32
