...
TEST_CINN_MKL_MATH_FP32(expf, false)
TEST_CINN_MKL_MATH_FP32(erff, false)
TEST_CINN_MKL_MATH_FP32(sqrtf, false)
TEST_CINN_MKL_MATH_FP32(logf, false)
TEST_MKL_MATH_FP32(log2f, true)
TEST_MKL_MATH_FP32(log10f, true)
TEST_CINN_MKL_MATH_FP32(floorf, false)
TEST_CINN_MKL_MATH_FP32(ceilf, false)
TEST_CINN_MKL_MATH_FP32(roundf, false)
TEST_MKL_MATH_FP32(truncf, true)
TEST_MKL_MATH_FP32(cosf, true)
TEST_MKL_MATH_FP32(coshf, true)
TEST_MKL_MATH_FP32(tanf, true)
TEST_MKL_MATH_FP32(sinf, true)
TEST_MKL_MATH_FP32(sinhf, true)
TEST_MKL_MATH_FP32(acosf, true)
TEST_MKL_MATH_FP32_SET(acoshf, true, 1.5)
TEST_MKL_MATH_FP32(asinf, true)
TEST_MKL_MATH_FP32(asinhf, true)
TEST_MKL_MATH_FP32(atanf, true)
TEST_MKL_MATH_FP32(atanhf, true)
TEST_MKL_MATH_FP32_BOOL(isnan, true)
TEST_CINN_MKL_MATH_FP32(tanhf, false)
