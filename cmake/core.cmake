...
set(fusion_pass_file ${CINN_BINARY_DIR}/cinn/hlir/pass/use_general_pass.h CACHE INTERNAL "use_general_pass.h file")
file(WRITE ${fusion_pass_file} "#include \"cinn/common/macros.h\" // Generated by the cinn/hlir/pass/CMakeLists.txt.  DO NOT EDIT!\n\n")
...
function(gather_srcs SRC_GROUP)
  ...
  foreach(cpp ${prefix_SRCS})
    ...
    find_fusion_pass_register("${CMAKE_CURRENT_SOURCE_DIR}/${cpp}" ${fusion_pass_file} "CINN_REGISTER_FUSION_PASS")
  endforeach()
endfunction()
