...
Here is a compiled wheel package of paddle compiled with CINN: 
`https://paddle-inference-dist.bj.bcebos.com/CINN_release/paddlepaddle_gpu-0.0.0-cp36-cp36m-linux_x86_64.whl`,
you can use it in 
