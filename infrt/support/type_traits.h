...
template <typename T>
using MaybeBase = llvm::conjunction<std::is_class<T>, llvm::negation<std::is_final<T>>>;
...
struct TupleIndexOf<T, std::tuple<T, Types...>> : std::integral_constant<size_t, 0> {};

template <class T, class U, class... Types>
struct TupleIndexOf<T, std::tuple<U, Types...>>
    : std::integral_constant<size_t, 1 + TupleIndexOf<T, std::tuple<Types...>>::value> {};

template <typename T, typename Tuple>
struct TupleHasType;

template <typename T, typename... Us>
struct TupleHasType<T, std::tuple<Us...>> : disjunction<std::is_same<T, Us>...> {};
